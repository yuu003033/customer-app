        ...
        <ul class="list-group list-group-flush">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" value="上"  name="rightUp" value="{{ $karute->rightUp }}">
                    <input type="text" class="form-control" id="validationCustom02" value="下" name="rightDown" value="{{ $karute->rightDown }}">
                
                </div>
                <div class="col-md-4">
                    <label for="validationCustom02" class="form-label">左目</label>
                    <input type="text" class="form-control" id="validationCustom03" value="上" name="leftUp" value="{{ $karute->leftUp }}">
                    <input type="text" class="form-control" id="validationCustom04" value="下" name="leftDown" value="{{ $karute->rightDown }}">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom05" value="右" name="eyebrowsRight" value="{{ $karute->eyebrowsRight }}">
                
                </div>
                <div class="col-md-4">
                    <label for="validationCustom04" class="form-label">まゆ毛</label>
                    <input type="text" class="form-control" id="validationCustom06" value="左" name="eyebrowsLeft" value="{{ $karute->eyebrowsLeft }}">               
                </div>  
            </div>
            </li>
        </ul>
