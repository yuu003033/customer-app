...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('karutes', function (Blueprint $table) {
            $table->id();
            $table->text('memo')->default('')->comment('施術内容');
            $table->string('extention')->default('')->comment('施術項目＜エクステ＞');
            $table->string('lashlift')->default('')->comment('施術項目＜パーマ＞');
            $table->string('eyebrows')->default('')->comment('施術項目＜まゆ毛＞');
            $table->string('upAndDown')->default('')->comment('施術項目＜上下＞');
            $table->string('lowerEyelashes')->default('')->comment('エクステ＜下まつ毛＞');
            $table->string('off')->default('')->comment('エクステ＜オフ有り＞');
            $table->string('rightUp')->default('')->comment('右目＜上＞');
            $table->string('leftUp')->default('')->comment('左目＜上＞');
            $table->string('rightDown')->default('')->comment('右目＜下＞');
            $table->string('leftDown')->default('')->comment('左目＜下＞');
            $table->string('eyebrowsRight')->default('')->comment('右まゆ毛');
            $table->string('eyebrowsLeft')->default('')->comment('左まゆ毛');
    ...
    public function down(): void
    {
        Schema::table('karutes', function(Blueprint $table){
            $table->text('memo')->nullable()->default('false')->comment('施術内容');
